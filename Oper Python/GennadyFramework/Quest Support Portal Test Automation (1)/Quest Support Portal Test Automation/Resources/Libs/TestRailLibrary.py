...
class TestRailLibrary:
    ...
    def Add_Result_To_TestRail_Case_Run_Config(self, project_name, plan_name, test_run_name, config, caseID, status, **kwargs):
    ...
    @staticmethod
    def Add_Test_Run_to_Plan_with_all_cases_configs(self, project_name, suite, plan_name, run_name, description, configs):
        planID = self.Get_TestRail_PlanID(self, project_name, plan_name)
    ...
    @staticmethod
    def Add_Test_Run_to_Plan_with_all_cases_configs_set(self, project_name, suite, plan_name, run_name, description, configs_set):
